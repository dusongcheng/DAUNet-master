...
def create_generator_val(load_name):
...
def validate(val_loader, model, criterion):
    ...
    for i, (img_B, img_A, img_A_1, img_name) in enumerate(val_loader):
        ...
        # save_img_path = os.path.join('/home/data/dusongcheng/Letter/MST-CSPN1_CAVE/save_model2023-04-18-09-43-26/result', img_name[0])
...
class Loss_valid(nn.Module):
    ...
    def forward(self, label_image, rec_image):
        ...
        valid_error[0, 4] = self.compute_sam()
        return valid_error
    ...
    def sam(self):
        ...
        recovered[np.where((np.linalg.norm(recovered, 2, 1)) == 0),] += 0.0001
