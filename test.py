...
if __name__ == "__main__":
    ...
    parse.add_argument('--baseroot', type=str, default='/home/data1/dusongcheng/CAVE_data')
    ...
    name = './model/CAVE.pkl'
    # Initialize
    model = utils.create_generator_val(name).cuda()
    # test_dataset = dataset.HyperDatasetValid()
